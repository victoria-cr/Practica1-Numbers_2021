...
public class NumbersTest {
    ...
    @org.junit.Test
    public void test5() {
        assertEquals("One thousand", Numbers.say(1_000));
        assertEquals("Two thousand", Numbers.say(2_000));
        assertEquals("Two thousand three hundred", Numbers.say(2_300));
        assertEquals("Four thousand five hundred and sixty-one", Numbers.say(4_561));
    }

    @org.junit.Test
    public void test6() {
        assertEquals("Ten thousand", Numbers.say(10_000));
        assertEquals("Thirteen thousand", Numbers.say(13_000));
        assertEquals("Twenty-one thousand", Numbers.say(21_000));
        assertEquals("Twenty-one thousand three hundred and one", Numbers.say(21_301));
        assertEquals("Ninety-nine thousand seven hundred and twenty-one", Numbers.say(99_721));
    }

    @org.junit.Test
    public void test7() {
        assertEquals("Two hundred thousand", Numbers.say(200_000));
        assertEquals("Three hundred and eleven thousand twenty-five", Numbers.say(311_025));
        assertEquals("Three hundred and eleven thousand nine hundred and twenty-five", Numbers.say(311_925));
    }

    @org.junit.Test
    public void test8() {
        assertEquals("One million", Numbers.say(1_000_000));
        assertEquals("Three million ten thousand", Numbers.say(3_010_000));
        assertEquals("Five million four hundred and thirty-two thousand six hundred and fifty-three",
                Numbers.say(5_432_653));
        assertEquals("Seven million six hundred and fifty thousand five hundred and six",
                Numbers.say(7_650_506));
